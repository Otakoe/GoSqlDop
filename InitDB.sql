...
insert into lifetime(user_id,status_time,status) values
    ...
    (1,(select adddate(now(), interval 34 hour)),'online'),
    (2,(select adddate(now(), interval 37 hour)),'online'),
    (3,(select adddate(now(), interval 32 hour)),'online'),
    (4,(select adddate(now(), interval 33 hour)),'online'),
    (1,(select adddate(now(), interval 45 hour)),'offline'),
    (2,(select adddate(now(), interval 48 hour)),'offline'),
    (3,(select adddate(now(), interval 47 hour)),'offline'),
    (4,(select adddate(now(), interval 44 hour)),'offline'),
	(1,(select adddate(now(), interval 53 hour)),'online'),
    (2,(select adddate(now(), interval 59 hour)),'online'),
    (3,(select adddate(now(), interval 51 hour)),'online'),
    (4,(select adddate(now(), interval 55 hour)),'online'),
    (1,(select adddate(now(), interval 62 hour)),'offline'),
    (2,(select adddate(now(), interval 69 hour)),'offline'),
    (3,(select adddate(now(), interval 65 hour)),'offline'),
    (4,(select adddate(now(), interval 63 hour)),'offline');
